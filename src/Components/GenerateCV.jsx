...
export const GenerateCV = ({ email, location, telephone, social }) => {
  ...
  const prepareResume = () => {
    ...
    // document.getElementById('resume__options').style.visibility = 'hidden';
    // document.getElementById('resume__generate').style.visibility = 'hidden';
  };
  ...
  const rollbackResume = () => {
    ...
    setSocialNodes([]);
    setSocialNodesText([]);
    // document.getElementById('resume__options').style.visibility = 'visible';
    // document.getElementById('resume__generate').style.visibility = 'visible';
  };
